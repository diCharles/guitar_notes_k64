...
/*!
 * \brief this function inits the serial communication via k20 chip, this chip will communicate
 *  with a computer by emulated terminal COM JLINK...
 *  return void
 * */
void UART_init_terminal_with_k20( uint32_t module_clk, uart_baud_rate_t baud_rate);
/*!
 * \brief this function inits uart4 to the desired baud rate
 *  with a computer by emulated terminal COM JLINK...
 *  return void
 * */
