...
bool_t GPIO_pin_control_register(gpio_port_name_t port_name, uint8_t pin, gpio_pin_control_register_t* pinControlRegister);
/*!
 	 \brief
 ...
 */
bool_t GPIO_read_pin(gpio_port_name_t port_name, uint8_t pin);
